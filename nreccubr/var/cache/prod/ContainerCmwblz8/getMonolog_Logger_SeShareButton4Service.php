...
// Returns the public 'monolog.logger.SeShareButton4' shared service.

$this->services['monolog.logger.SeShareButton4'] = $instance = new \Symfony\Bridge\Monolog\Logger('SeShareButton4');
...
$instance->pushHandler(${($_ = isset($this->services['monolog.handler.SeShareButton4']) ? $this->services['monolog.handler.SeShareButton4'] : $this->load('getMonolog_Handler_SeShareButton4Service.php')) && false ?: '_'});
